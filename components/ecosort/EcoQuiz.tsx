...
const QUIZ_QUESTIONS: Question[] = [
  {
    ...
    correctIndex: 1,
    explanation: "Oil & grease contaminate paper pulp fibers during paper recycling, ruining clean paper batches! Put greasy cardboard in compost or trash."
  },
  {
    question: "What should you NEVER do with dead AA batteries?",
    options: [
      "Store them in a dry plastic box",
    ...
    correctIndex: 2,
    explanation: "Batteries contain toxic heavy metals and acids that leak into soil or ignite chemical fires when compressed in regular trash trucks."
  },
  {
    ...
    options: [
      ...
      "Because cans are made from paper",
      "Because aluminum dissolves in water"
    ],
    correctIndex: 1,
    explanation: "Remelting recycled aluminum requires 95% less energy than mining and smelting raw bauxite ore!"
  }
];
    ...
    <div className="p-6 sm:p-8 rounded-3xl bg-slate-900/90 border border-slate-800 shadow-2xl space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-slate-800">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="font-bold text-white text-lg">Student Recycling Quick Quiz</h3>
            <p className="text-slate-400 text-xs">Test your knowledge on waste sorting & recycling</p>
          </div>
        </div>
      ...
      {!isFinished ? (
        ...
        <div className="text-center py-6 space-y-4">
          ...
          <p className="text-slate-300 text-sm">
            You scored <strong className="text-amber-400 text-lg">{score}</strong> out of <strong>{QUIZ_QUESTIONS.length}</strong>!
          </p>
